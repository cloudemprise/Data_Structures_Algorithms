...
The space complexity of this solution is O(1), since it uses a constant amount
of extra space regardless of the size of the input. This is because the function
does not use any additional data structures to store information about the tree.
*/

// lowestCommonAncestor iteratively searches for the lowest common ancestor of
